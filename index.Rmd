---
title: "Skyspatial services to detect disease cluster"
...
For more accurate risk estimation—and ultimately better cluster identification—it’s essential to include risk factors in the model. For lung cancer, for example, including pollution levels like $\text{PM}_{2.5}$ as a risk factor can significantly improve our estimates. Our services in skyspatial leverage satellite data for risk factors like pollution to enhance the accuracy of these disease risk models, helping decision-makers allocate resources more efficiently.


- To access our **Skyspatial** application for detecting disease clusters, click [here](https://skyspatial-281410227287.us-central1.run.app/).
